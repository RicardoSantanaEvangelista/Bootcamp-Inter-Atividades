...
let name = new String("João Ricardo de Santana Evangelista"); //Objeto

console.log(name.length);

console.log(nome, " ",sobreNome); // Formas de concatenar

console.log(nome,"\n",sobreNome); // Quebrando a linha

console.log(`${nome} ${sobreNome} = ${name}`); // Outra forma de concatenar
